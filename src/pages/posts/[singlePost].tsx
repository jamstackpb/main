...
export async function getStaticPaths({ content }: InferGetStaticPropsType<typeof getStaticProps>) {
    // Get the paths we want to pre-render based on posts
    const paths = content.map((content) => ({ params: { singlePost: content.slug } }));
